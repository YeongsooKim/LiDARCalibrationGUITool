...
class DataValidation(QWidget):
    def __init__(self, form_widget):
        ...
        self.progress_status = CONST_STOP
        self.result_labels = {}
        self.label_heading_threshold = self.form_widget.config.PARM_DV['filter_HeadingThreshold']
        self.label_distance_threshold = self.form_widget.config.PARM_DV['filter_DistanceThreshold']
        self.initUi()
    ...
    def EndValibration(self):
        ...
        # print(self.form_widget.config.PARM_DV['filter_HeadingThreshold'])

        # element.ValidationConfigLabel.label_edit_heading_threshold.setText(format(self.form_widget.config.PARM_DV['filter_HeadingThreshold'],".4f"))
        # element.ValidationConfigLabel.label_edit_heading_threshold.setText(format(self.form_widget.config.PARM_DV['filter_DistanceThreshold'],".4f"))

        print(self.form_widget.config.PARM_DV['filter_HeadingThreshold'])

        # self.label_heading_threshold = QLabel('Heading Threshold [deg]: {}'.format(self.form_widget.config.PARM_DV['filter_HeadingThreshold']))

        # self.label_distance_threshold = QLabel('Distance Threshold [m]: {}'.format(self.form_widget.config.PARM_DV['filter_DistanceThreshold']))
